        ...
        fun bind(data: DocumentSnapshot, position: Int) {
            ...
            transactionGroup?.let {
                itemView.apply {
                    ...
                    actualAmountText.text = it.actual?.let { "${context.getString(R.string.currency)}${it.toStringAddCommas()}" } ?: ""
                    targetAmountLabel.text = it.targetText ?: ""
                    targetAmountText.text = it.target?.let { "${context.getString(R.string.currency)}${it.toStringAddCommas()}" } ?: ""
